...
class Athlete(models.Model):
    ...
    individual_kata_event = models.CharField(max_length=22, choices=get_all_individual_kata_choices())
    individual_kumite_event = models.CharField(max_length=22, choices=get_all_individual_kumite_choices())
    team_kata_event = models.CharField(max_length=22, choices=get_all_team_kata_choices())
    team_kumite_event = models.CharField(max_length=22, choices=get_all_team_kumite_choices())
